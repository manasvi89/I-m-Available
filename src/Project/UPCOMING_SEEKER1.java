 ...
 * @author hp
 */
public class UPCOMING_SEEKER1 extends javax.swing.JFrame {
    static int acc_id;
    ...
    public UPCOMING_SEEKER1(int acc_id) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("U P C O M I N G  R I D E S :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UPCOMING_SEEKER1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new UPCOMING_SEEKER1(acc_id).setVisible(true);
        });
    }
    void detail(int acc_id) throws SQLException{
        CallableStatement cstmt = conn.prepareCall("{call hr.up_seeker(?,?,?,?,?,?,?,?,?)}");
        ...
        String no1[] = no.split(",");
          ...
          Object data[][] = new Object[name1.length][9];
        ...
        String[] columnNames = {"Sr.No","Helper Name","Helper Contact No","Origin","Destination","Date", "Time","Payment mode", "Fare amount"};

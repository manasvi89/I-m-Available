 ...
 * @author hp
 */
public class PAST_SEEKER1 extends javax.swing.JFrame {
    static int acc_id;
    ...
    public PAST_SEEKER1(int acc_id) {

        initComponents();
        PAST_SEEKER1.acc_id = acc_id;
...
void detail(int acc_id) throws SQLException{
        CallableStatement cstmt = conn.prepareCall("{call hr.hist1(?,?,?,?,?,?,?,?)}");
        ...
        String[] columnNames = {"Sr.No","Helper Name","Origin","Destination","Date", "Time","Payment mode", "Fare amount"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PAST_SEEKER1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PAST_SEEKER1(acc_id).setVisible(true);
        });
    }

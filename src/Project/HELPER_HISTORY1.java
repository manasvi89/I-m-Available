 ...
 * @author hp
 */
public class HELPER_HISTORY1 extends javax.swing.JFrame {
static int acc_id;
    /**
     * Creates new form welcome_window
     */
    public HELPER_HISTORY1(int acc_id) {
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        PAST_HELER1 u = new PAST_HELER1(acc_id);
        u.setVisible(true);
        u.pack();
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        UPCOMING_HELER1 u = new UPCOMING_HELER1(acc_id);
        u.setVisible(true);
        u.pack();
        u.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HELPER_HISTORY1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new HELPER_HISTORY1(acc_id).setVisible(true);
        });
    }

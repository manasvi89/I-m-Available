 ...
 * @author hp
 */
public class UPCOMING_HELER1 extends javax.swing.JFrame {
    static int acc_id;
    ...
    public UPCOMING_HELER1(int acc_id) {
...
void detail(int acc_id) throws SQLException{
        CallableStatement cstmt = conn.prepareCall("{call hr.up_helper(?,?,?,?,?,?,?,?,?)}");
        ...
        String[] columnNames = {"Sr.No","Seeker Name","Seeker Contact No","Origin","Destination","Date", "Time","Payment mode", "Fare amount"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UPCOMING_HELER1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new UPCOMING_HELER1(acc_id).setVisible(true);
        });
    }

...
public class UPCOMING_RENT1 extends javax.swing.JFrame {
    static int acc_id;
    ...
    public UPCOMING_RENT1(int acc_id) {

        initComponents();
        UPCOMING_RENT1.acc_id = acc_id;
...
void detail(int id) throws SQLException{
        CallableStatement cstmt = conn.prepareCall("{call hr.up_rent(?,?,?,?,?,?,?,?)}");
        cstmt.setInt(1, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UPCOMING_RENT1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new UPCOMING_RENT1(acc_id).setVisible(true);
        });
    }

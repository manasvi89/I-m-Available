 ...
 * @author hp
 */
public class SEEKER_HISTORY1 extends javax.swing.JFrame {
static int acc_id;
    /**
     * Creates new form welcome_window
     */
    public SEEKER_HISTORY1(int acc_id) {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("U P C O M I N G  R I D E  H I S T O R Y");
        ...
        jLabel15.setText("P A S T  R I D E S  H I S T O R Y");
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        PAST_SEEKER1 u = new PAST_SEEKER1(acc_id);
        u.setVisible(true);
        u.pack();
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        UPCOMING_SEEKER1 u = new UPCOMING_SEEKER1(acc_id);
        u.setVisible(true);
        u.pack();
        u.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SEEKER_HISTORY1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SEEKER_HISTORY1(acc_id).setVisible(true);
        });
    }

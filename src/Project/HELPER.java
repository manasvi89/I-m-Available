...
int temp;
    ...
    private void initComponents() {
        ...
        jLabel15.setText("P E N D I N G  R E Q U E S T S");
    ...
    try {
        PENDING_REQUEST1 u = new PENDING_REQUEST1(acc_id);
        u.setVisible(true);
        u.pack();
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        HELPER_HISTORY1 u = new HELPER_HISTORY1(acc_id);
        u.setVisible(true);
        u.pack();
        u.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new HELPER(acc_id).setVisible(true);
        });
    }
void check_vehicle() throws ClassNotFoundException 
 {
     try {
         try {
         ...
         String insertQuery1 = "insert into HR.helper_details(account_id) values(" + acc_id + ")";
         int r = stmt.executeUpdate(insertQuery1);
         HELPER1 u;
        u = new HELPER1(acc_id);
        u.setVisible(true);
        u.pack();
        u.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
         ...
         JOptionPane.showMessageDialog(null,"Raise_Application_Error -20107 : You don't have Vehicle details! ");
